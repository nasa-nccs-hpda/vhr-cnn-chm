...
# from tensorflow_caney.networks.unet_regression import \
# unet_batchnorm_regression
...
class CNNRegressionPipeline(object):
    ...
    def get_wv_tile_data(self, atl08_gpkg_filename):
        ...
        for _, poly_row in atl08_data.iterrows():
            ...
            if clipped_data.shape[1] < self.conf.tile_size \
                ...
                continue
            # print("Did not stop because of size")

            # validate there is no no-data on the tile
            if clipped_data.min() < -100:
                continue
            # print("Did not stop because of min")
            ...
            if self.conf.landcover_directory is not None \
                    and self.conf.landcover_preprocessing:
            ...
            # landcover is used as a postprocessing step
                ...
                # print("Entered the famous else", poly_row['h_can'])
            ...
            # print(output_dir_data, output_dir_label)
    ...
    def preprocess(self):
        ...
        os.makedirs(self.conf.intersection_output_dir, exist_ok=True)
